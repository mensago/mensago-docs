...
All fields are required except for `Device-Name` and `Device-Description`. The `From` field is the domain for the organization, which may or may not be the same as that of the recipient. The payload is encrypted using the recipient's contact request encryption key. Like all system messages, it is signed by the organization's primary signing key.
...
Parameters: Device-ID, Device-Key, optional: Device-Name. optional: Device-Description +
...
Parameters: Domain or Workspace-ID, Index +
Returns: 200 OK, Is-Current
...
Parameters: Login-Type, Workspace-ID, Challenge +
Returns: 100 CONTINUE server response +
...
Returns: 104 TRANSFER, Item-Count, Total-Size +
...
Parameters: Workspace ID (optional), User ID (optional), Domain (optional) +
Returns: 200 OK, Workspace-ID, Reg-Code, Domain, User-ID +
...
Parameters: Workspace-ID or User-ID, Reg-Code, Password-Hash, Device-ID, Device-Key, optional: Domain
public key +
...
Parameters: Workspace-ID, Password-Hash, Device-ID, Device-Key, optional: User-ID +
Returns: +
...
Parameters: Password-Hash NewPassword-Hash +
Returns: 200 OK, 402 AUTHENTICATION FAILURE
