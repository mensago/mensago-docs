...
As a platform, Mensago places minimum trust in infrastructure and plans for compromise.

=== Server

A Mensago server is intended to act as an verifying third party for identity services and to provide message delivery and device synchronization.