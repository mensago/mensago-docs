...
Bio:: OPTIONAL. Privacy level `Public`. This is a public-facing biographical string where a user can construct a quick blurb to summarize important aspects of their life and/or personality.
